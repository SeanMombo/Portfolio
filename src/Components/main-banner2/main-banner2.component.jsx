...
import "./main-banner2.styles.scss"
            ...
            <div className='main-banner'>
                ...
                <div class="main-banner-content">  
                    ...
                    {/* <div class="logo-container">  
                            ...
                            <svg id="svg" version="1.1" xmlns="http://www.w3.org/2000/svg" width="400" height="408.79120879120876" viewBox="-300, -300, 1000, 1009">
                                ...
                                stroke="none" fill="#faf7eb" fill-rule="evenodd" transform='rotate(45)'></path></g>
                            </svg>
                            
                        </div> */}
                         
                        <h1>SEAN<span className='span1'>MOMBO</span></h1>
                ...
                {/* <div className="hero-corner hiddec-anim" ></div>
                    ...
                    <div className="quote-container">
                        <p>
                            I have two insatiable desires — to learn and to create.
                            </p>
                    </div>
